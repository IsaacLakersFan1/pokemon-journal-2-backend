...
router.post('/pokemon', authMiddleware_1.authenticateJWT, pokemonController_1.createPokemon);
// GET: Get all Pokémon
...
router.put('/pokemon/:id', authMiddleware_1.authenticateJWT, pokemonController_1.updatePokemon);
// DELETE: Delete Pokémon by ID
router.delete('/pokemon/:id', authMiddleware_1.authenticateJWT, pokemonController_1.deletePokemon);
